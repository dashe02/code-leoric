...
public class CalPriceFactory {
    ...
    private static final String CAL_PRICE_PACKAGE = "com.leoric.code.design.pattern.strategy";//这里是一个常量，表示我们扫描策略的包

    private static ClassLoader classLoader = CalPriceFactory.class.getClassLoader();
